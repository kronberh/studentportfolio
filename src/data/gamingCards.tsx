...
const gamingCards: GamingCard[] = [
    {
        ...
        videoPath: "./src/assets/minecraft_firework_crafter.mp4",
        links: [
            { icon: <FaVideo />, href: "./src/assets/minecraft_firework_crafter.mp4" },
    ...
    },
    {
        ...
        videoPath: "./src/assets/tower_heroes_minesweeper.mp4",
        links: [
            { icon: <FaVideo />, href: "./src/assets/tower_heroes_minesweeper.mp4" },
    ...
    },
    {
        ...
        videoPath: "./src/assets/geometry_dash_the_towerverse.mp4",
        links: [
            { icon: <FaVideo />, href: "./src/assets/geometry_dash_the_towerverse.mp4" },
    ...
    },
    {
        ...
        videoPath: "./src/assets/robeats_last_attack_hard.mp4",
        links: [
            { icon: <FaVideo />, href: "./src/assets/robeats_last_attack_hard.mp4" },
